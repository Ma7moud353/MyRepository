...
public class Maze
{
    ...
    public static void main(String[] args)
    {
        int[][] grid = {
            ...
            { WALL, EMPTY, WALL, EMPTY, EMPTY, WALL,  WALL, EMPTY,  WALL, WALL},
        ...
        while(!done && charIndex < solutionLength)
        {
            ...
            switch(direction)
            {
                ...
                default:
                    System.out.println("Yho have no idea where you are going."); // Invalid direction.
            }
            ...
            else
            {
                ...
                else if(grid[currentRow][currentCol] == WALL)
                {
                    ...
                    System.out.println("You stumble blindly into solid concrete wall."); // Hit wall.
                }
                else if(grid[currentRow][currentCol] == END)
                {
                    done = true;
                    solved = true;
                    System.out.println("SLOVED!"); // Solved.
                }
                else
                {} // Do nothing
            }
        ...
        if(!solved)
        {
            System.out.println("You have failed to escape. Future archeologists gaze upon your remain in bafflement"); // Did not reach the end.
        }
